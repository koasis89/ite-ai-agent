# Ralph 업스트림 → OMX 패리티 매트릭스

기준 소스: `docs/reference/ralph-upstream-baseline.md`(`165c3688bfde275560c001a0de4c7563cf82ad69`)
...
- **채택됨**: OMX 런타임에서 직접 구현된 동작입니다.
- **적응됨**: OMX 관련 계약/범위 코디네이션(Coordination)으로 구현된 동작입니다.
- **범위 밖**: 문서화되었지만 의도적으로 런타임 동작으로 구현되지 않았습니다.


참조: `docs/contracts/ralph-state-contract.md`, `docs/contracts/ralph-cancel-contract.md`, `docs/qa/ralph-persistence-gate.md`
